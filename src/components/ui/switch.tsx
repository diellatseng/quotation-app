    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          'group-data-[size=sm]/switch:size-4 group-data-[size=default]/switch:size-5',
          'group-data-[size=sm]/switch:data-checked:translate-x-4 group-data-[size=default]/switch:data-checked:translate-x-5',
          'group-data-[size=sm]/switch:data-unchecked:translate-x-0.5 group-data-[size=default]/switch:data-unchecked:translate-x-0.5'
        )}
      />
    </SwitchPrimitive.Root>
  )
