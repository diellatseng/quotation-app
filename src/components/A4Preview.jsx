...
const A4Preview = forwardRef(function A4Preview(
  ...
  const sections = buildSections({
    quotation, services, stages, client, contactPerson,
    companyInfo, total, taxAmount, grandTotal, hasChecklist, negLogs,
  })
...
function buildSections({
    ...
    element: (
      <div>
        <div className="a4-header">
          ...
          <div className="a4-doc-title">報　價　單</div>
        </div>
  ...
  if (servicesWithDesc.length > 0) {
    sec.push({
      ...
      forceNewPage: true,
      element: (
        <div className="a4-appendix-header">
          <div className="a4-header">
            <div className="a4-appendix-title">服務細項說明</div>
          </div>
          <div className="a4-rule" />
          <div className="a4-appendix-meta">
  ...
  // ── Appendix 2 — Client document checklist ──
  if (hasChecklist) {
    sec.push({
      ...
      element: (
        <div className="a4-appendix-header">
          <div className="a4-header">
            <div className="a4-appendix-title">客戶準備資料清單</div>
          </div>
          <div className="a4-rule" />
          <div className="a4-appendix-meta">
            客戶：{client?.company_name} ／ 地號：{quotation.land_section}
